...
public class Tarificador {
	...
	public ArrayList<ProductoCotizador> cotizacionVenta() {
        ...
        productos.add(new ProductoCotizador("N", ProductoCotizador.TELEFONIA, telefonia, "000", "N/A", TO_I_IVA, TO_P_IVA, 0, 0));
		productos.add(new ProductoCotizador("N", ProductoCotizador.TELEVISION, television, "000", "N/A", TV_I_IVA, TV_P_IVA, 0, 0));
		productos.add(new ProductoCotizador("N", ProductoCotizador.INTERNET, internet, "000", "N/A", BA_I_IVA, BA_P_IVA, 0, 0));
