 ...
 * @author Giovanny
 */
public class ListaDialogoResumenAdapter extends BaseAdapter {

    protected Activity activity;
    protected ArrayList<ListaPrecios> items;
    public ListaAgendamiento item;

    public ListaDialogoResumenAdapter(Activity activity, ArrayList<ListaPrecios> items, Context ctx) {
